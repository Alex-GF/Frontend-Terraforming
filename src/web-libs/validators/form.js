    ...
    switch (e.target.name){
        ...
        case "usuario":
            ...
            if(expresiones.usuario.test(e.target.value)){ 
                ...
                document.getElementById("usuario-input-login").classList.remove('incorrecto');
                document.getElementById("usuario-input-login").classList.add('correcto');

            }else{

                document.getElementById("usuario-input-login").classList.remove('correcto');
                document.getElementById("usuario-input-login").classList.add('incorrecto');
        ...
        case "password":
            ...
            if(expresiones.usuario.test(e.target.value)){ 
                ...
                document.getElementById("password-input-login").classList.remove('incorrecto');
                document.getElementById("password-input-login").classList.add('correcto');

            }else{

                document.getElementById("password-input-login").classList.remove('correcto');
                document.getElementById("password-input-login").classList.add('incorrecto');
